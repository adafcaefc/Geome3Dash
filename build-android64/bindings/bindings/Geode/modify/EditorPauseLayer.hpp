...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EditorPauseLayer> : ModifyBase<ModifyDerive<Der, EditorPauseLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::enumKeyCodes>::func(&EditorPauseLayer::keyDown)), Default, EditorPauseLayer, keyDown, cocos2d::enumKeyCodes)
