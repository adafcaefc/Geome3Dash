...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCSpeed> : ModifyBase<ModifyDerive<Der, cocos2d::CCSpeed>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSpeed::getInnerAction)), Default, cocos2d::CCSpeed, getInnerAction, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSpeed::getSpeed)), Default, cocos2d::CCSpeed, getSpeed, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCSpeed::setSpeed)), Default, cocos2d::CCSpeed, setSpeed, float)
