...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCLayerColor> : ModifyBase<ModifyDerive<Der, cocos2d::CCLayerColor>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccColor4B const&, float, float>::func(&cocos2d::CCLayerColor::initWithColor)), Default, cocos2d::CCLayerColor, initWithColor, cocos2d::_ccColor4B const&, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccColor4B const&>::func(&cocos2d::CCLayerColor::initWithColor)), Default, cocos2d::CCLayerColor, initWithColor, cocos2d::_ccColor4B const&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccColor3B const&>::func(&cocos2d::CCLayerColor::setColor)), Default, cocos2d::CCLayerColor, setColor, cocos2d::_ccColor3B const&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccBlendFunc>::func(&cocos2d::CCLayerColor::setBlendFunc)), Default, cocos2d::CCLayerColor, setBlendFunc, cocos2d::_ccBlendFunc)
