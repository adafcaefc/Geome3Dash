...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCParticleSystemQuad> : ModifyBase<ModifyDerive<Der, cocos2d::CCParticleSystemQuad>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystemQuad::getOpacity)), Default, cocos2d::CCParticleSystemQuad, getOpacity, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned char>::func(&cocos2d::CCParticleSystemQuad::setOpacity)), Default, cocos2d::CCParticleSystemQuad, setOpacity, unsigned char)
