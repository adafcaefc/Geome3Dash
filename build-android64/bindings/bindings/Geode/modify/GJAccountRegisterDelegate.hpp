...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJAccountRegisterDelegate> : ModifyBase<ModifyDerive<Der, GJAccountRegisterDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJAccountRegisterDelegate::registerAccountFinished)), Default, GJAccountRegisterDelegate, registerAccountFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<AccountError>::func(&GJAccountRegisterDelegate::registerAccountFailed)), Default, GJAccountRegisterDelegate, registerAccountFailed, AccountError)
		}
	};
}
