...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCScheduler> : ModifyBase<ModifyDerive<Der, cocos2d::CCScheduler>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCScheduler::getTimeScale)), Default, cocos2d::CCScheduler, getTimeScale, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCScheduler::setTimeScale)), Default, cocos2d::CCScheduler, setTimeScale, float)
