...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::ZipUtils> : ModifyBase<ModifyDerive<Der, cocos2d::ZipUtils>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d8ZipUtils14encryptDecryptERKSsi")), Default, cocos2d::ZipUtils, encryptDecrypt, gd::string const&, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d8ZipUtils18encryptDecryptWKeyERKSsSs")), Default, cocos2d::ZipUtils, encryptDecryptWKey, gd::string const&, gd::string)
