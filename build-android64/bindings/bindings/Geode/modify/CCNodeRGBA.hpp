...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCNodeRGBA> : ModifyBase<ModifyDerive<Der, cocos2d::CCNodeRGBA>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccColor3B const&>::func(&cocos2d::CCNodeRGBA::setColor)), Default, cocos2d::CCNodeRGBA, setColor, cocos2d::_ccColor3B const&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccColor3B const&>::func(&cocos2d::CCNodeRGBA::updateDisplayedColor)), Default, cocos2d::CCNodeRGBA, updateDisplayedColor, cocos2d::_ccColor3B const&)
