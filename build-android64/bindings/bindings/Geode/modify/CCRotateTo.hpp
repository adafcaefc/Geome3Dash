...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCRotateTo> : ModifyBase<ModifyDerive<Der, cocos2d::CCRotateTo>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float, float>::func(&cocos2d::CCRotateTo::initWithDuration)), Default, cocos2d::CCRotateTo, initWithDuration, float, float, float)
