...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ListButtonBarDelegate> : ModifyBase<ModifyDerive<Der, ListButtonBarDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<ListButtonBar*, int>::func(&ListButtonBarDelegate::listButtonBarSwitchedPage)), Default, ListButtonBarDelegate, listButtonBarSwitchedPage, ListButtonBar*, int)
		}
	};
}
