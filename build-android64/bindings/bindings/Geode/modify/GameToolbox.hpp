...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GameToolbox> : ModifyBase<ModifyDerive<Der, GameToolbox>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<long>::func(&GameToolbox::timestampToHumanReadable)), Default, GameToolbox, timestampToHumanReadable, long)
