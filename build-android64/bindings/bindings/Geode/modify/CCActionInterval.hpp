...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCActionInterval> : ModifyBase<ModifyDerive<Der, cocos2d::CCActionInterval>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCActionInterval::getM_bFirstTick)), Default, cocos2d::CCActionInterval, getM_bFirstTick, )
