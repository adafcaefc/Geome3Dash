...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CustomSFXDelegate> : ModifyBase<ModifyDerive<Der, CustomSFXDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<SFXInfoObject*>::func(&CustomSFXDelegate::sfxObjectSelected)), Default, CustomSFXDelegate, sfxObjectSelected, SFXInfoObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&CustomSFXDelegate::getActiveSFXID)), Default, CustomSFXDelegate, getActiveSFXID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<SFXInfoObject*>::func(&CustomSFXDelegate::overridePlaySFX)), Default, CustomSFXDelegate, overridePlaySFX, SFXInfoObject*)
		}
	};
}
