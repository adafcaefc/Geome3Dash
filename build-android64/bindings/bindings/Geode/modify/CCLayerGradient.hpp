...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCLayerGradient> : ModifyBase<ModifyDerive<Der, cocos2d::CCLayerGradient>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCLayerGradient::getShouldPremultiply)), Default, cocos2d::CCLayerGradient, getShouldPremultiply, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCLayerGradient::setShouldPremultiply)), Default, cocos2d::CCLayerGradient, setShouldPremultiply, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::_ccColor3B const&, unsigned char, cocos2d::_ccColor3B const&, unsigned char, cocos2d::CCPoint const&>::func(&cocos2d::CCLayerGradient::setValues)), Default, cocos2d::CCLayerGradient, setValues, cocos2d::_ccColor3B const&, unsigned char, cocos2d::_ccColor3B const&, unsigned char, cocos2d::CCPoint const&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccColor4B const&, cocos2d::_ccColor4B const&>::func(&cocos2d::CCLayerGradient::initWithColor)), Default, cocos2d::CCLayerGradient, initWithColor, cocos2d::_ccColor4B const&, cocos2d::_ccColor4B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccColor4B const&, cocos2d::_ccColor4B const&, cocos2d::CCPoint const&>::func(&cocos2d::CCLayerGradient::initWithColor)), Default, cocos2d::CCLayerGradient, initWithColor, cocos2d::_ccColor4B const&, cocos2d::_ccColor4B const&, cocos2d::CCPoint const&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccColor3B const&>::func(&cocos2d::CCLayerGradient::setStartColor)), Default, cocos2d::CCLayerGradient, setStartColor, cocos2d::_ccColor3B const&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccColor3B const&>::func(&cocos2d::CCLayerGradient::setEndColor)), Default, cocos2d::CCLayerGradient, setEndColor, cocos2d::_ccColor3B const&)
