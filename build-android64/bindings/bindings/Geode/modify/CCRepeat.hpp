...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCRepeat> : ModifyBase<ModifyDerive<Der, cocos2d::CCRepeat>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCRepeat::getInnerAction)), Default, cocos2d::CCRepeat, getInnerAction, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCFiniteTimeAction*>::func(&cocos2d::CCRepeat::setInnerAction)), Default, cocos2d::CCRepeat, setInnerAction, cocos2d::CCFiniteTimeAction*)
