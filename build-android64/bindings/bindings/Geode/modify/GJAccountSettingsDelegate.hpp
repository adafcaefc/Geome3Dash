...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJAccountSettingsDelegate> : ModifyBase<ModifyDerive<Der, GJAccountSettingsDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJAccountSettingsDelegate::updateSettingsFinished)), Default, GJAccountSettingsDelegate, updateSettingsFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJAccountSettingsDelegate::updateSettingsFailed)), Default, GJAccountSettingsDelegate, updateSettingsFailed, )
		}
	};
}
