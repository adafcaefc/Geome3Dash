...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SelectSFXSortDelegate> : ModifyBase<ModifyDerive<Der, SelectSFXSortDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<SelectSFXSortLayer*>::func(&SelectSFXSortDelegate::sortSelectClosed)), Default, SelectSFXSortDelegate, sortSelectClosed, SelectSFXSortLayer*)
		}
	};
}
