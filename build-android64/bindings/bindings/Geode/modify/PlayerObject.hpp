...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, PlayerObject> : ModifyBase<ModifyDerive<Der, PlayerObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&PlayerObject::postCollision)), Default, PlayerObject, postCollision, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(PlayerObject, setYVelocity, double, int)
