...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCAnimate> : ModifyBase<ModifyDerive<Der, cocos2d::CCAnimate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCAnimate::getAnimation)), Default, cocos2d::CCAnimate, getAnimation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCAnimate::getRecenterChildren)), Default, cocos2d::CCAnimate, getRecenterChildren, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCAnimate::getRecenterFrames)), Default, cocos2d::CCAnimate, getRecenterFrames, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCAnimation*>::func(&cocos2d::CCAnimate::setAnimation)), Default, cocos2d::CCAnimate, setAnimation, cocos2d::CCAnimation*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCAnimate::setRecenterChildren)), Default, cocos2d::CCAnimate, setRecenterChildren, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCAnimate::setRecenterFrames)), Default, cocos2d::CCAnimate, setRecenterFrames, bool)
