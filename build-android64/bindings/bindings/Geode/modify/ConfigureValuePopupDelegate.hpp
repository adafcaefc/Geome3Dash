...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ConfigureValuePopupDelegate> : ModifyBase<ModifyDerive<Der, ConfigureValuePopupDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<ConfigureValuePopup*, float>::func(&ConfigureValuePopupDelegate::valuePopupClosed)), Default, ConfigureValuePopupDelegate, valuePopupClosed, ConfigureValuePopup*, float)
		}
	};
}
