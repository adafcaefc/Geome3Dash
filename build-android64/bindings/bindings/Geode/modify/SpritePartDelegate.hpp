...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SpritePartDelegate> : ModifyBase<ModifyDerive<Der, SpritePartDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN18SpritePartDelegate19displayFrameChangedEPN7cocos2d8CCObjectESs")), Default, SpritePartDelegate, displayFrameChanged, cocos2d::CCObject*, gd::string)
		}
	};
}
