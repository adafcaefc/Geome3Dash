...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCImage> : ModifyBase<ModifyDerive<Der, cocos2d::CCImage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCImage::getBitsPerComponent)), Default, cocos2d::CCImage, getBitsPerComponent, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCImage::getData)), Default, cocos2d::CCImage, getData, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCImage::getDataLen)), Default, cocos2d::CCImage, getDataLen, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCImage::getHeight)), Default, cocos2d::CCImage, getHeight, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCImage::getWidth)), Default, cocos2d::CCImage, getWidth, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<void*, int>::func(&cocos2d::CCImage::_initWithWebpData)), Default, cocos2d::CCImage, _initWithWebpData, void*, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCImage::hasAlpha)), Default, cocos2d::CCImage, hasAlpha, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCImage::isPremultipliedAlpha)), Default, cocos2d::CCImage, isPremultipliedAlpha, )
