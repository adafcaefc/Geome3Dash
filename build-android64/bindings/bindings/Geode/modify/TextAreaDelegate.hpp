...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, TextAreaDelegate> : ModifyBase<ModifyDerive<Der, TextAreaDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<TextArea*>::func(&TextAreaDelegate::fadeInTextFinished)), Default, TextAreaDelegate, fadeInTextFinished, TextArea*)
		}
	};
}
