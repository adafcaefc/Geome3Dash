...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EnhancedGameObject> : ModifyBase<ModifyDerive<Der, EnhancedGameObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<GJBaseGameLayer*>::func(&EnhancedGameObject::stateSensitiveOff)), Default, EnhancedGameObject, stateSensitiveOff, GJBaseGameLayer*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&EnhancedGameObject::resumeAudio)), Default, EnhancedGameObject, resumeAudio, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&EnhancedGameObject::resumeAudioDelayed)), Default, EnhancedGameObject, resumeAudioDelayed, )
