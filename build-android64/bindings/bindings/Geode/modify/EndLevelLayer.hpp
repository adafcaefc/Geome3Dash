...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EndLevelLayer> : ModifyBase<ModifyDerive<Der, EndLevelLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::enumKeyCodes>::func(&EndLevelLayer::keyDown)), Default, EndLevelLayer, keyDown, cocos2d::enumKeyCodes)
