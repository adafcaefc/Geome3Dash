...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::extension::CCHttpClient> : ModifyBase<ModifyDerive<Der, cocos2d::extension::CCHttpClient>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::extension::CCHttpClient::lazyInitThreadSemphore)), Default, cocos2d::extension::CCHttpClient, lazyInitThreadSemphore, )
