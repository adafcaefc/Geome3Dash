...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, PlatformToolbox> : ModifyBase<ModifyDerive<Der, PlatformToolbox>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&PlatformToolbox::getDeviceRefreshRate)), Default, PlatformToolbox, getDeviceRefreshRate, )
