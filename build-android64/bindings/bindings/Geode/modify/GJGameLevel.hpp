...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJGameLevel> : ModifyBase<ModifyDerive<Der, GJGameLevel>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int>::func(&GJGameLevel::saveNewScore)), Default, GJGameLevel, saveNewScore, int, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJGameLevel::setAccountID)), Default, GJGameLevel, setAccountID, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJGameLevel::setAttempts)), Default, GJGameLevel, setAttempts, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJGameLevel::setAttemptTime)), Default, GJGameLevel, setAttemptTime, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJGameLevel::setClicks)), Default, GJGameLevel, setClicks, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJGameLevel::setCoinsVerified)), Default, GJGameLevel, setCoinsVerified, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJGameLevel::setDailyID)), Default, GJGameLevel, setDailyID, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJGameLevel::setDemon)), Default, GJGameLevel, setDemon, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJGameLevel::setJumps)), Default, GJGameLevel, setJumps, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJGameLevel::setLevelID)), Default, GJGameLevel, setLevelID, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJGameLevel::setNewNormalPercent)), Default, GJGameLevel, setNewNormalPercent, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJGameLevel::setNewNormalPercent2)), Default, GJGameLevel, setNewNormalPercent2, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJGameLevel::setObjectCount)), Default, GJGameLevel, setObjectCount, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJGameLevel::setOriginalLevel)), Default, GJGameLevel, setOriginalLevel, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJGameLevel::setPassword)), Default, GJGameLevel, setPassword, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&GJGameLevel::setStars)), Default, GJGameLevel, setStars, int)
