...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, BoomScrollLayerDelegate> : ModifyBase<ModifyDerive<Der, BoomScrollLayerDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<BoomScrollLayer*>::func(&BoomScrollLayerDelegate::scrollLayerScrollingStarted)), Default, BoomScrollLayerDelegate, scrollLayerScrollingStarted, BoomScrollLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<BoomScrollLayer*, int>::func(&BoomScrollLayerDelegate::scrollLayerScrolledToPage)), Default, BoomScrollLayerDelegate, scrollLayerScrolledToPage, BoomScrollLayer*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCPoint>::func(&BoomScrollLayerDelegate::scrollLayerMoved)), Default, BoomScrollLayerDelegate, scrollLayerMoved, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<BoomScrollLayer*, int>::func(&BoomScrollLayerDelegate::scrollLayerWillScrollToPage)), Default, BoomScrollLayerDelegate, scrollLayerWillScrollToPage, BoomScrollLayer*, int)
		}
	};
}
