...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UserInfoDelegate> : ModifyBase<ModifyDerive<Der, UserInfoDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<GJUserScore*>::func(&UserInfoDelegate::getUserInfoFinished)), Default, UserInfoDelegate, getUserInfoFinished, GJUserScore*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int>::func(&UserInfoDelegate::getUserInfoFailed)), Default, UserInfoDelegate, getUserInfoFailed, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<GJUserScore*>::func(&UserInfoDelegate::userInfoChanged)), Default, UserInfoDelegate, userInfoChanged, GJUserScore*)
		}
	};
}
