...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AnimatedSpriteDelegate> : ModifyBase<ModifyDerive<Der, AnimatedSpriteDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<char const*>::func(&AnimatedSpriteDelegate::animationFinished)), Default, AnimatedSpriteDelegate, animationFinished, char const*)
		}
	};
}
