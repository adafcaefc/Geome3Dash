...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, PlayLayer> : ModifyBase<ModifyDerive<Der, PlayLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&PlayLayer::testTime)), Default, PlayLayer, testTime, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&PlayLayer::resetLevel)), Default, PlayLayer, resetLevel, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&PlayLayer::setDamageVerifiedIdx)), Default, PlayLayer, setDamageVerifiedIdx, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&PlayLayer::toggleDebugDraw)), Default, PlayLayer, toggleDebugDraw, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<EffectGameObject*, float>::func(&PlayLayer::updateTimeWarp)), Default, PlayLayer, updateTimeWarp, EffectGameObject*, float)
		}
	};
}
