...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCLightning> : ModifyBase<ModifyDerive<Der, cocos2d::CCLightning>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccColor3B const&>::func(&cocos2d::CCLightning::setColor)), Default, cocos2d::CCLightning, setColor, cocos2d::_ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccColor3B const&>::func(&cocos2d::CCLightning::updateDisplayedColor)), Default, cocos2d::CCLightning, updateDisplayedColor, cocos2d::_ccColor3B const&)
