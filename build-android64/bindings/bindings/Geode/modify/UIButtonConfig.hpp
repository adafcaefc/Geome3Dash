...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UIButtonConfig> : ModifyBase<ModifyDerive<Der, UIButtonConfig>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&UIButtonConfig::reset)), Default, UIButtonConfig, reset, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&UIButtonConfig::resetOneBtn)), Default, UIButtonConfig, resetOneBtn, )
		}
	};
}
