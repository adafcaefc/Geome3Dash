...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCLayer> : ModifyBase<ModifyDerive<Der, cocos2d::CCLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCLayer::getScriptAccelerateHandlerEntry)), Default, cocos2d::CCLayer, getScriptAccelerateHandlerEntry, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCLayer::getScriptKeypadHandlerEntry)), Default, cocos2d::CCLayer, getScriptKeypadHandlerEntry, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCLayer::getScriptTouchHandlerEntry)), Default, cocos2d::CCLayer, getScriptTouchHandlerEntry, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::enumKeyCodes>::func(&cocos2d::CCLayer::keyDown)), Default, cocos2d::CCLayer, keyDown, cocos2d::enumKeyCodes)
		}
	};
}
