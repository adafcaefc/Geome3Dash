...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCParticleSystem> : ModifyBase<ModifyDerive<Der, cocos2d::CCParticleSystem>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getAtlasIndex)), Default, cocos2d::CCParticleSystem, getAtlasIndex, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getDontCleanupOnFinish)), Default, cocos2d::CCParticleSystem, getDontCleanupOnFinish, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getDynamicRotationIsDir)), Default, cocos2d::CCParticleSystem, getDynamicRotationIsDir, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getEndRGBVarSync)), Default, cocos2d::CCParticleSystem, getEndRGBVarSync, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getFadeInTime)), Default, cocos2d::CCParticleSystem, getFadeInTime, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getFadeInTimeVar)), Default, cocos2d::CCParticleSystem, getFadeInTimeVar, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getFadeOutTime)), Default, cocos2d::CCParticleSystem, getFadeOutTime, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getFadeOutTimeVar)), Default, cocos2d::CCParticleSystem, getFadeOutTimeVar, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getFrictionPos)), Default, cocos2d::CCParticleSystem, getFrictionPos, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getFrictionPosVar)), Default, cocos2d::CCParticleSystem, getFrictionPosVar, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getFrictionRot)), Default, cocos2d::CCParticleSystem, getFrictionRot, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getFrictionRotVar)), Default, cocos2d::CCParticleSystem, getFrictionRotVar, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getFrictionSize)), Default, cocos2d::CCParticleSystem, getFrictionSize, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getFrictionSizeVar)), Default, cocos2d::CCParticleSystem, getFrictionSizeVar, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getOrderSensitive)), Default, cocos2d::CCParticleSystem, getOrderSensitive, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getRespawn)), Default, cocos2d::CCParticleSystem, getRespawn, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getRespawnVar)), Default, cocos2d::CCParticleSystem, getRespawnVar, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getStartRGBVarSync)), Default, cocos2d::CCParticleSystem, getStartRGBVarSync, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getStartRadiusEqualToEnd)), Default, cocos2d::CCParticleSystem, getStartRadiusEqualToEnd, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getStartSizeEqualToEnd)), Default, cocos2d::CCParticleSystem, getStartSizeEqualToEnd, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getStartSpinEqualToEnd)), Default, cocos2d::CCParticleSystem, getStartSpinEqualToEnd, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getUseUniformColorMode)), Default, cocos2d::CCParticleSystem, getUseUniformColorMode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getUsingSchedule)), Default, cocos2d::CCParticleSystem, getUsingSchedule, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCParticleSystem::getWasRemoved)), Default, cocos2d::CCParticleSystem, getWasRemoved, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCParticleSystem::setAtlasIndex)), Default, cocos2d::CCParticleSystem, setAtlasIndex, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCParticleSystem::setDontCleanupOnFinish)), Default, cocos2d::CCParticleSystem, setDontCleanupOnFinish, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCParticleSystem::setDynamicRotationIsDir)), Default, cocos2d::CCParticleSystem, setDynamicRotationIsDir, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setEndAlpha)), Default, cocos2d::CCParticleSystem, setEndAlpha, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCParticleSystem::setEndRGBVarSync)), Default, cocos2d::CCParticleSystem, setEndRGBVarSync, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setFadeInTime)), Default, cocos2d::CCParticleSystem, setFadeInTime, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setFadeInTimeVar)), Default, cocos2d::CCParticleSystem, setFadeInTimeVar, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setFadeOutTime)), Default, cocos2d::CCParticleSystem, setFadeOutTime, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setFadeOutTimeVar)), Default, cocos2d::CCParticleSystem, setFadeOutTimeVar, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setFrictionPos)), Default, cocos2d::CCParticleSystem, setFrictionPos, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setFrictionPosVar)), Default, cocos2d::CCParticleSystem, setFrictionPosVar, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setFrictionRot)), Default, cocos2d::CCParticleSystem, setFrictionRot, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setFrictionRotVar)), Default, cocos2d::CCParticleSystem, setFrictionRotVar, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setFrictionSize)), Default, cocos2d::CCParticleSystem, setFrictionSize, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setFrictionSizeVar)), Default, cocos2d::CCParticleSystem, setFrictionSizeVar, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCParticleSystem::setOrderSensitive)), Default, cocos2d::CCParticleSystem, setOrderSensitive, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setRespawn)), Default, cocos2d::CCParticleSystem, setRespawn, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setRespawnVar)), Default, cocos2d::CCParticleSystem, setRespawnVar, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCParticleSystem::setStartAlpha)), Default, cocos2d::CCParticleSystem, setStartAlpha, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCParticleSystem::setStartRGBVarSync)), Default, cocos2d::CCParticleSystem, setStartRGBVarSync, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCParticleSystem::setStartRadiusEqualToEnd)), Default, cocos2d::CCParticleSystem, setStartRadiusEqualToEnd, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCParticleSystem::setStartSizeEqualToEnd)), Default, cocos2d::CCParticleSystem, setStartSizeEqualToEnd, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCParticleSystem::setStartSpinEqualToEnd)), Default, cocos2d::CCParticleSystem, setStartSpinEqualToEnd, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCParticleSystem::setUsingSchedule)), Default, cocos2d::CCParticleSystem, setUsingSchedule, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCParticleSystem::setWasRemoved)), Default, cocos2d::CCParticleSystem, setWasRemoved, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCParticleSystem::toggleUniformColorMode)), Default, cocos2d::CCParticleSystem, toggleUniformColorMode, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccColor4F const&>::func(&cocos2d::CCParticleSystem::setStartColor)), Default, cocos2d::CCParticleSystem, setStartColor, cocos2d::_ccColor4F const&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccColor4F const&>::func(&cocos2d::CCParticleSystem::setStartColorVar)), Default, cocos2d::CCParticleSystem, setStartColorVar, cocos2d::_ccColor4F const&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccColor4F const&>::func(&cocos2d::CCParticleSystem::setEndColor)), Default, cocos2d::CCParticleSystem, setEndColor, cocos2d::_ccColor4F const&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccColor4F const&>::func(&cocos2d::CCParticleSystem::setEndColorVar)), Default, cocos2d::CCParticleSystem, setEndColorVar, cocos2d::_ccColor4F const&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccBlendFunc>::func(&cocos2d::CCParticleSystem::setBlendFunc)), Default, cocos2d::CCParticleSystem, setBlendFunc, cocos2d::_ccBlendFunc)
