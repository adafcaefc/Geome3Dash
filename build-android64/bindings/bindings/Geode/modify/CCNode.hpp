...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCNode> : ModifyBase<ModifyDerive<Der, cocos2d::CCNode>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCNode::getScriptHandler)), Default, cocos2d::CCNode, getScriptHandler, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCNode::getTransformTemp)), Default, cocos2d::CCNode, getTransformTemp, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCNode::getUseChildIndex)), Default, cocos2d::CCNode, getUseChildIndex, )
