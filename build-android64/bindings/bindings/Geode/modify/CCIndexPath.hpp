...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCIndexPath> : ModifyBase<ModifyDerive<Der, CCIndexPath>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, int>::func(&CCIndexPath::CCIndexPathWithSectionRow)), Default, CCIndexPath, CCIndexPathWithSectionRow, int, int)
		}
	};
}
