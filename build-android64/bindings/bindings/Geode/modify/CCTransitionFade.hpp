...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionFade> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionFade>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float, cocos2d::CCScene*, cocos2d::_ccColor3B const&>::func(&cocos2d::CCTransitionFade::initWithDuration)), Default, cocos2d::CCTransitionFade, initWithDuration, float, cocos2d::CCScene*, cocos2d::_ccColor3B const&)
		}
	};
}
