...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, RewardedVideoDelegate> : ModifyBase<ModifyDerive<Der, RewardedVideoDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&RewardedVideoDelegate::rewardedVideoFinished)), Default, RewardedVideoDelegate, rewardedVideoFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&RewardedVideoDelegate::shouldOffsetRewardCurrency)), Default, RewardedVideoDelegate, shouldOffsetRewardCurrency, )
		}
	};
}
