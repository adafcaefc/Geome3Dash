...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SongPlaybackDelegate> : ModifyBase<ModifyDerive<Der, SongPlaybackDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<SongInfoObject*>::func(&SongPlaybackDelegate::onPlayback)), Default, SongPlaybackDelegate, onPlayback, SongInfoObject*)
		}
	};
}
