...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJAccountDelegate> : ModifyBase<ModifyDerive<Der, GJAccountDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJAccountDelegate::accountStatusChanged)), Default, GJAccountDelegate, accountStatusChanged, )
		}
	};
}
