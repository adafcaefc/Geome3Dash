...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LevelInfoLayer> : ModifyBase<ModifyDerive<Der, LevelInfoLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::enumKeyCodes>::func(&LevelInfoLayer::keyDown)), Default, LevelInfoLayer, keyDown, cocos2d::enumKeyCodes)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&LevelInfoLayer::onFeatured)), Default, LevelInfoLayer, onFeatured, cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&LevelInfoLayer::onLowDetailMode)), Default, LevelInfoLayer, onLowDetailMode, cocos2d::CCObject*)
