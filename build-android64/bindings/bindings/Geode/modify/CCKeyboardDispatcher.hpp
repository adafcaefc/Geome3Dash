...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCKeyboardDispatcher> : ModifyBase<ModifyDerive<Der, cocos2d::CCKeyboardDispatcher>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCKeyboardDispatcher::getAltKeyPressed)), Default, cocos2d::CCKeyboardDispatcher, getAltKeyPressed, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCKeyboardDispatcher::getBlockRepeat)), Default, cocos2d::CCKeyboardDispatcher, getBlockRepeat, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCKeyboardDispatcher::getCommandKeyPressed)), Default, cocos2d::CCKeyboardDispatcher, getCommandKeyPressed, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCKeyboardDispatcher::getControlKeyPressed)), Default, cocos2d::CCKeyboardDispatcher, getControlKeyPressed, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCKeyboardDispatcher::getShiftKeyPressed)), Default, cocos2d::CCKeyboardDispatcher, getShiftKeyPressed, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCKeyboardDispatcher::setBlockRepeat)), Default, cocos2d::CCKeyboardDispatcher, setBlockRepeat, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::enumKeyCodes, bool, bool>::func(&cocos2d::CCKeyboardDispatcher::dispatchKeyboardMSG)), Default, cocos2d::CCKeyboardDispatcher, dispatchKeyboardMSG, cocos2d::enumKeyCodes, bool, bool)
