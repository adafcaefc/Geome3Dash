...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ListUploadDelegate> : ModifyBase<ModifyDerive<Der, ListUploadDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<GJLevelList*>::func(&ListUploadDelegate::listUploadFinished)), Default, ListUploadDelegate, listUploadFinished, GJLevelList*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<GJLevelList*, int>::func(&ListUploadDelegate::listUploadFailed)), Default, ListUploadDelegate, listUploadFailed, GJLevelList*, int)
		}
	};
}
