...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJEffectManager> : ModifyBase<ModifyDerive<Der, GJEffectManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJEffectManager::rewardedVideoFinished)), Default, GJEffectManager, rewardedVideoFinished, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&GJEffectManager::onRewardedVideo)), Default, GJEffectManager, onRewardedVideo, cocos2d::CCObject*)
