...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, OptionsObjectDelegate> : ModifyBase<ModifyDerive<Der, OptionsObjectDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<OptionsObject*>::func(&OptionsObjectDelegate::stateChanged)), Default, OptionsObjectDelegate, stateChanged, OptionsObject*)
		}
	};
}
