...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCArray> : ModifyBase<ModifyDerive<Der, cocos2d::CCArray>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCArray::init)), Default, cocos2d::CCArray, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCArray*>::func(&cocos2d::CCArray::initWithArray)), Default, cocos2d::CCArray, initWithArray, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::CCArray::initWithObject)), Default, cocos2d::CCArray, initWithObject, cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCArray::capacity)), Default, cocos2d::CCArray, capacity, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*, cocos2d::CCObject*>::func(&cocos2d::CCArray::exchangeObject)), Default, cocos2d::CCArray, exchangeObject, cocos2d::CCObject*, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, unsigned int>::func(&cocos2d::CCArray::exchangeObjectAtIndex)), Default, cocos2d::CCArray, exchangeObjectAtIndex, unsigned int, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCArray::fastRemoveObjectAtIndex)), Default, cocos2d::CCArray, fastRemoveObjectAtIndex, unsigned int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::CCArray::indexOfObject)), Default, cocos2d::CCArray, indexOfObject, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*, unsigned int>::func(&cocos2d::CCArray::insertObject)), Default, cocos2d::CCArray, insertObject, cocos2d::CCObject*, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCArray*>::func(&cocos2d::CCArray::isEqualToArray)), Default, cocos2d::CCArray, isEqualToArray, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCArray::randomObject)), Default, cocos2d::CCArray, randomObject, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCArray::reduceMemoryFootprint)), Default, cocos2d::CCArray, reduceMemoryFootprint, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*, bool>::func(&cocos2d::CCArray::removeObject)), Default, cocos2d::CCArray, removeObject, cocos2d::CCObject*, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCArray*>::func(&cocos2d::CCArray::removeObjectsInArray)), Default, cocos2d::CCArray, removeObjectsInArray, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, cocos2d::CCObject*, bool>::func(&cocos2d::CCArray::replaceObjectAtIndex)), Default, cocos2d::CCArray, replaceObjectAtIndex, unsigned int, cocos2d::CCObject*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCArray::reverseObjects)), Default, cocos2d::CCArray, reverseObjects, )
