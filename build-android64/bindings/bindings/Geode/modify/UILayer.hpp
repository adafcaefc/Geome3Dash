...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UILayer> : ModifyBase<ModifyDerive<Der, UILayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::enumKeyCodes>::func(&UILayer::keyDown)), Default, UILayer, keyDown, cocos2d::enumKeyCodes)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::enumKeyCodes>::func(&UILayer::keyUp)), Default, UILayer, keyUp, cocos2d::enumKeyCodes)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::enumKeyCodes, bool>::func(&UILayer::handleKeypress)), Default, UILayer, handleKeypress, cocos2d::enumKeyCodes, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<GJUITouchEvent, int, cocos2d::CCPoint, GJUINode*>::func(&UILayer::processUINodeTouch)), Default, UILayer, processUINodeTouch, GJUITouchEvent, int, cocos2d::CCPoint, GJUINode*)
