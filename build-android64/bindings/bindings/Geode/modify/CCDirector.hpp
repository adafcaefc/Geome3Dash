...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCDirector> : ModifyBase<ModifyDerive<Der, cocos2d::CCDirector>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getActualDeltaTime)), Default, cocos2d::CCDirector, getActualDeltaTime, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getAnimationInterval)), Default, cocos2d::CCDirector, getAnimationInterval, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getContentScaleFactor)), Default, cocos2d::CCDirector, getContentScaleFactor, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getDontCallWillSwitch)), Default, cocos2d::CCDirector, getDontCallWillSwitch, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getIsTransitioning)), Default, cocos2d::CCDirector, getIsTransitioning, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getLoadedTextureQuality)), Default, cocos2d::CCDirector, getLoadedTextureQuality, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getNextScene)), Default, cocos2d::CCDirector, getNextScene, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getOpenGLView)), Default, cocos2d::CCDirector, getOpenGLView, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getProjection)), Default, cocos2d::CCDirector, getProjection, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getRunningScene)), Default, cocos2d::CCDirector, getRunningScene, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getSceneReference)), Default, cocos2d::CCDirector, getSceneReference, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getScreenScaleFactor)), Default, cocos2d::CCDirector, getScreenScaleFactor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getScreenScaleFactorH)), Default, cocos2d::CCDirector, getScreenScaleFactorH, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getScreenScaleFactorMax)), Default, cocos2d::CCDirector, getScreenScaleFactorMax, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getScreenScaleFactorW)), Default, cocos2d::CCDirector, getScreenScaleFactorW, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getSecondsPerFrame)), Default, cocos2d::CCDirector, getSecondsPerFrame, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getSmoothFix)), Default, cocos2d::CCDirector, getSmoothFix, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getSmoothFixCheck)), Default, cocos2d::CCDirector, getSmoothFixCheck, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getSmoothFixCounter)), Default, cocos2d::CCDirector, getSmoothFixCounter, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getTotalFrames)), Default, cocos2d::CCDirector, getTotalFrames, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCDirector::setActualDeltaTime)), Default, cocos2d::CCDirector, setActualDeltaTime, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCDirector::setDisplayStats)), Default, cocos2d::CCDirector, setDisplayStats, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCDirector::setDontCallWillSwitch)), Default, cocos2d::CCDirector, setDontCallWillSwitch, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCNode*>::func(&cocos2d::CCDirector::setNotificationNode)), Default, cocos2d::CCDirector, setNotificationNode, cocos2d::CCNode*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCScene*>::func(&cocos2d::CCDirector::setSceneReference)), Default, cocos2d::CCDirector, setSceneReference, cocos2d::CCScene*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCDirector::setSmoothFix)), Default, cocos2d::CCDirector, setSmoothFix, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCDirector::setSmoothFixCheck)), Default, cocos2d::CCDirector, setSmoothFixCheck, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::isDisplayStats)), Default, cocos2d::CCDirector, isDisplayStats, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::isNextDeltaTimeZero)), Default, cocos2d::CCDirector, isNextDeltaTimeZero, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::isPaused)), Default, cocos2d::CCDirector, isPaused, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::isSendCleanupToScene)), Default, cocos2d::CCDirector, isSendCleanupToScene, )
