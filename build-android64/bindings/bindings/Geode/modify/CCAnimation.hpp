...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCAnimation> : ModifyBase<ModifyDerive<Der, cocos2d::CCAnimation>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCAnimation::getDelayPerUnit)), Default, cocos2d::CCAnimation, getDelayPerUnit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCAnimation::getFrames)), Default, cocos2d::CCAnimation, getFrames, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCAnimation::getLoops)), Default, cocos2d::CCAnimation, getLoops, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCAnimation::getRestoreOriginalFrame)), Default, cocos2d::CCAnimation, getRestoreOriginalFrame, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCAnimation::getTotalDelayUnits)), Default, cocos2d::CCAnimation, getTotalDelayUnits, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCAnimation::setDelayPerUnit)), Default, cocos2d::CCAnimation, setDelayPerUnit, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCArray*>::func(&cocos2d::CCAnimation::setFrames)), Default, cocos2d::CCAnimation, setFrames, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCAnimation::setLoops)), Default, cocos2d::CCAnimation, setLoops, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCAnimation::setRestoreOriginalFrame)), Default, cocos2d::CCAnimation, setRestoreOriginalFrame, bool)
