...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCMotionStreak> : ModifyBase<ModifyDerive<Der, cocos2d::CCMotionStreak>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float, float, cocos2d::_ccColor3B const&, cocos2d::CCTexture2D*>::func(&cocos2d::CCMotionStreak::initWithFade)), Default, cocos2d::CCMotionStreak, initWithFade, float, float, float, cocos2d::_ccColor3B const&, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, float, float, cocos2d::_ccColor3B const&, char const*>::func(&cocos2d::CCMotionStreak::initWithFade)), Default, cocos2d::CCMotionStreak, initWithFade, float, float, float, cocos2d::_ccColor3B const&, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCMotionStreak::getDontOpacityFade)), Default, cocos2d::CCMotionStreak, getDontOpacityFade, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(cocos2d::CCMotionStreak, getM_fMaxSeg, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCMotionStreak::setDontOpacityFade)), Default, cocos2d::CCMotionStreak, setDontOpacityFade, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCMotionStreak::setFastMode)), Default, cocos2d::CCMotionStreak, setFastMode, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(cocos2d::CCMotionStreak, setM_fMaxSeg, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCMotionStreak::setStartingPositionInitialized)), Default, cocos2d::CCMotionStreak, setStartingPositionInitialized, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCMotionStreak::isFastMode)), Default, cocos2d::CCMotionStreak, isFastMode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCMotionStreak::isStartingPositionInitialized)), Default, cocos2d::CCMotionStreak, isStartingPositionInitialized, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::_ccColor3B>::func(&cocos2d::CCMotionStreak::tintWithColor)), Default, cocos2d::CCMotionStreak, tintWithColor, cocos2d::_ccColor3B)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccBlendFunc>::func(&cocos2d::CCMotionStreak::setBlendFunc)), Default, cocos2d::CCMotionStreak, setBlendFunc, cocos2d::_ccBlendFunc)
