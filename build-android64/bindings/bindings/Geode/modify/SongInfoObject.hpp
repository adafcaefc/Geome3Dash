...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SongInfoObject> : ModifyBase<ModifyDerive<Der, SongInfoObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN14SongInfoObject6createEiSsSsifSsSsSsiSsbii")), Default, SongInfoObject, create, int, gd::string, gd::string, int, float, gd::string, gd::string, gd::string, int, gd::string, bool, int, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN14SongInfoObject4initEiSsSsifSsSsSsiSsbii")), Default, SongInfoObject, init, int, gd::string, gd::string, int, float, gd::string, gd::string, gd::string, int, gd::string, bool, int, int)
