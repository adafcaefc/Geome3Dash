...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJSpecialColorSelectDelegate> : ModifyBase<ModifyDerive<Der, GJSpecialColorSelectDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<GJSpecialColorSelect*, int>::func(&GJSpecialColorSelectDelegate::colorSelectClosed)), Default, GJSpecialColorSelectDelegate, colorSelectClosed, GJSpecialColorSelect*, int)
		}
	};
}
