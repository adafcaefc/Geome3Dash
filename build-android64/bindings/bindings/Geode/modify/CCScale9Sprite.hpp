...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::extension::CCScale9Sprite> : ModifyBase<ModifyDerive<Der, cocos2d::extension::CCScale9Sprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<GLubyte>::func(&cocos2d::extension::CCScale9Sprite::setOpacity)), Default, cocos2d::extension::CCScale9Sprite, setOpacity, GLubyte)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<GLubyte>::func(&cocos2d::extension::CCScale9Sprite::updateDisplayedOpacity)), Default, cocos2d::extension::CCScale9Sprite, updateDisplayedOpacity, GLubyte)
