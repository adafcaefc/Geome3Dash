...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCRepeatForever> : ModifyBase<ModifyDerive<Der, cocos2d::CCRepeatForever>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCRepeatForever::getInnerAction)), Default, cocos2d::CCRepeatForever, getInnerAction, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCActionInterval*>::func(&cocos2d::CCRepeatForever::setInnerAction)), Default, cocos2d::CCRepeatForever, setInnerAction, cocos2d::CCActionInterval*)
