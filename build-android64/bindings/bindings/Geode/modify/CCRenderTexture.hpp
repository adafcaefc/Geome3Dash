...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCRenderTexture> : ModifyBase<ModifyDerive<Der, cocos2d::CCRenderTexture>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::_ccColor4F const&>::func(&cocos2d::CCRenderTexture::setClearColor)), Default, cocos2d::CCRenderTexture, setClearColor, cocos2d::_ccColor4F const&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCRenderTexture::endToLua)), Default, cocos2d::CCRenderTexture, endToLua, )
