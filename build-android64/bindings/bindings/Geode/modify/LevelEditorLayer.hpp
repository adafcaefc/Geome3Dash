...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LevelEditorLayer> : ModifyBase<ModifyDerive<Der, LevelEditorLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCArray*, cocos2d::CCDictionary*>::func(&LevelEditorLayer::addExclusionList)), Default, LevelEditorLayer, addExclusionList, cocos2d::CCArray*, cocos2d::CCDictionary*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCArray*>::func(&LevelEditorLayer::getNextFreeAreaEffectID)), Default, LevelEditorLayer, getNextFreeAreaEffectID, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCArray*>::func(&LevelEditorLayer::getNextFreeBlockID)), Default, LevelEditorLayer, getNextFreeBlockID, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCArray*>::func(&LevelEditorLayer::getNextFreeEditorLayer)), Default, LevelEditorLayer, getNextFreeEditorLayer, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCArray*>::func(&LevelEditorLayer::getNextFreeEnterChannel)), Default, LevelEditorLayer, getNextFreeEnterChannel, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCArray*>::func(&LevelEditorLayer::getNextFreeGradientID)), Default, LevelEditorLayer, getNextFreeGradientID, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCArray*>::func(&LevelEditorLayer::getNextFreeGroupID)), Default, LevelEditorLayer, getNextFreeGroupID, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCArray*>::func(&LevelEditorLayer::getNextFreeItemID)), Default, LevelEditorLayer, getNextFreeItemID, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCArray*>::func(&LevelEditorLayer::getNextFreeOrderChannel)), Default, LevelEditorLayer, getNextFreeOrderChannel, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCArray*>::func(&LevelEditorLayer::getNextFreeSFXGroupID)), Default, LevelEditorLayer, getNextFreeSFXGroupID, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCArray*>::func(&LevelEditorLayer::getNextFreeSFXID)), Default, LevelEditorLayer, getNextFreeSFXID, cocos2d::CCArray*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&LevelEditorLayer::setObjectCount)), Default, LevelEditorLayer, setObjectCount, int)
