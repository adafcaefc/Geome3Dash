...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCObject> : ModifyBase<ModifyDerive<Der, cocos2d::CCObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCObject::getObjType)), Default, cocos2d::CCObject, getObjType, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObjectType>::func(&cocos2d::CCObject::setObjType)), Default, cocos2d::CCObject, setObjType, cocos2d::CCObjectType)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCObject::copy)), Default, cocos2d::CCObject, copy, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCObject::retainCount)), Default, cocos2d::CCObject, retainCount, )
