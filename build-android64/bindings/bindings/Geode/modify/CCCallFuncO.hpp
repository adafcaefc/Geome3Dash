...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCCallFuncO> : ModifyBase<ModifyDerive<Der, cocos2d::CCCallFuncO>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*, cocos2d::SEL_MenuHandler, cocos2d::CCObject*>::func(&cocos2d::CCCallFuncO::initWithTarget)), Default, cocos2d::CCCallFuncO, initWithTarget, cocos2d::CCObject*, cocos2d::SEL_MenuHandler, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCCallFuncO::getObject)), Default, cocos2d::CCCallFuncO, getObject, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*>::func(&cocos2d::CCCallFuncO::setObject)), Default, cocos2d::CCCallFuncO, setObject, cocos2d::CCObject*)
