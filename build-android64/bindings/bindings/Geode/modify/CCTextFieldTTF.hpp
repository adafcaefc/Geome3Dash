...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTextFieldTTF> : ModifyBase<ModifyDerive<Der, cocos2d::CCTextFieldTTF>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTextFieldDelegate*>::func(&cocos2d::CCTextFieldTTF::setDelegate)), Default, cocos2d::CCTextFieldTTF, setDelegate, cocos2d::CCTextFieldDelegate*)
