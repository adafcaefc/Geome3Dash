...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCSpriteFrame> : ModifyBase<ModifyDerive<Der, cocos2d::CCSpriteFrame>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSpriteFrame::getFrameName)), Default, cocos2d::CCSpriteFrame, getFrameName, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSpriteFrame::getOriginalSize)), Default, cocos2d::CCSpriteFrame, getOriginalSize, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSpriteFrame::getOriginalSizeInPixels)), Default, cocos2d::CCSpriteFrame, getOriginalSizeInPixels, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSpriteFrame::getRect)), Default, cocos2d::CCSpriteFrame, getRect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSpriteFrame::getRectInPixels)), Default, cocos2d::CCSpriteFrame, getRectInPixels, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d13CCSpriteFrame12setFrameNameESs")), Default, cocos2d::CCSpriteFrame, setFrameName, gd::string)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSize const&>::func(&cocos2d::CCSpriteFrame::setOriginalSize)), Default, cocos2d::CCSpriteFrame, setOriginalSize, cocos2d::CCSize const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSize const&>::func(&cocos2d::CCSpriteFrame::setOriginalSizeInPixels)), Default, cocos2d::CCSpriteFrame, setOriginalSizeInPixels, cocos2d::CCSize const&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCSpriteFrame::setRotated)), Default, cocos2d::CCSpriteFrame, setRotated, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSpriteFrame::isRotated)), Default, cocos2d::CCSpriteFrame, isRotated, )
