...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, TableViewCellDelegate> : ModifyBase<ModifyDerive<Der, TableViewCellDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<TableViewCell*, int, CellAction, cocos2d::CCNode*>::func(&TableViewCellDelegate::cellPerformedAction)), Default, TableViewCellDelegate, cellPerformedAction, TableViewCell*, int, CellAction, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&TableViewCellDelegate::getSelectedCellIdx)), Default, TableViewCellDelegate, getSelectedCellIdx, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&TableViewCellDelegate::shouldSnapToSelected)), Default, TableViewCellDelegate, shouldSnapToSelected, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&TableViewCellDelegate::getCellDelegateType)), Default, TableViewCellDelegate, getCellDelegateType, )
		}
	};
}
