...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SFXBrowserDelegate> : ModifyBase<ModifyDerive<Der, SFXBrowserDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<SFXBrowser*>::func(&SFXBrowserDelegate::sfxBrowserClosed)), Default, SFXBrowserDelegate, sfxBrowserClosed, SFXBrowser*)
		}
	};
}
