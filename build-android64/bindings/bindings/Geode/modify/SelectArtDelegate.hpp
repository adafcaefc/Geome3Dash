...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SelectArtDelegate> : ModifyBase<ModifyDerive<Der, SelectArtDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<SelectArtLayer*>::func(&SelectArtDelegate::selectArtClosed)), Default, SelectArtDelegate, selectArtClosed, SelectArtLayer*)
		}
	};
}
