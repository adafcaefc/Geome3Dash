...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCSprite> : ModifyBase<ModifyDerive<Der, cocos2d::CCSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSprite::getAtlasIndex)), Default, cocos2d::CCSprite, getAtlasIndex, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSprite::getBlVertexMod)), Default, cocos2d::CCSprite, getBlVertexMod, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSprite::getBrVertexMod)), Default, cocos2d::CCSprite, getBrVertexMod, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSprite::getDontDraw)), Default, cocos2d::CCSprite, getDontDraw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSprite::getOffsetPosition)), Default, cocos2d::CCSprite, getOffsetPosition, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSprite::getQuad)), Default, cocos2d::CCSprite, getQuad, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSprite::getTextureAtlas)), Default, cocos2d::CCSprite, getTextureAtlas, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSprite::getTextureRect)), Default, cocos2d::CCSprite, getTextureRect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSprite::getTlVertexMod)), Default, cocos2d::CCSprite, getTlVertexMod, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSprite::getTrVertexMod)), Default, cocos2d::CCSprite, getTrVertexMod, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSprite::getUnflippedOffsetPosition)), Default, cocos2d::CCSprite, getUnflippedOffsetPosition, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSprite::getUseVertexMod)), Default, cocos2d::CCSprite, getUseVertexMod, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int>::func(&cocos2d::CCSprite::setAtlasIndex)), Default, cocos2d::CCSprite, setAtlasIndex, unsigned int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCSprite::setBlVertexMod)), Default, cocos2d::CCSprite, setBlVertexMod, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCSprite::setBrVertexMod)), Default, cocos2d::CCSprite, setBrVertexMod, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCSprite::setDontDraw)), Default, cocos2d::CCSprite, setDontDraw, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCTextureAtlas*>::func(&cocos2d::CCSprite::setTextureAtlas)), Default, cocos2d::CCSprite, setTextureAtlas, cocos2d::CCTextureAtlas*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCSprite::setTlVertexMod)), Default, cocos2d::CCSprite, setTlVertexMod, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&cocos2d::CCSprite::setTrVertexMod)), Default, cocos2d::CCSprite, setTrVertexMod, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCSprite::setUseVertexMod)), Default, cocos2d::CCSprite, setUseVertexMod, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCSprite::isTextureRectRotated)), Default, cocos2d::CCSprite, isTextureRectRotated, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccColor3B const&>::func(&cocos2d::CCSprite::setChildColor)), Default, cocos2d::CCSprite, setChildColor, cocos2d::_ccColor3B const&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccColor3B const&>::func(&cocos2d::CCSprite::setColor)), Default, cocos2d::CCSprite, setColor, cocos2d::_ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccColor3B const&>::func(&cocos2d::CCSprite::updateDisplayedColor)), Default, cocos2d::CCSprite, updateDisplayedColor, cocos2d::_ccColor3B const&)
