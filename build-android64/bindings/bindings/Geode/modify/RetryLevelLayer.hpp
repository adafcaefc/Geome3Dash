...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, RetryLevelLayer> : ModifyBase<ModifyDerive<Der, RetryLevelLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::enumKeyCodes>::func(&RetryLevelLayer::keyDown)), Default, RetryLevelLayer, keyDown, cocos2d::enumKeyCodes)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&RetryLevelLayer::shouldOffsetRewardCurrency)), Default, RetryLevelLayer, shouldOffsetRewardCurrency, )
