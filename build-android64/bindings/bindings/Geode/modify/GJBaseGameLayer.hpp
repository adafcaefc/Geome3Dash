...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJBaseGameLayer> : ModifyBase<ModifyDerive<Der, GJBaseGameLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&GJBaseGameLayer::postUpdate)), Default, GJBaseGameLayer, postUpdate, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJBaseGameLayer::checkForEnd)), Default, GJBaseGameLayer, checkForEnd, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJBaseGameLayer::testTime)), Default, GJBaseGameLayer, testTime, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJBaseGameLayer::updateVerifyDamage)), Default, GJBaseGameLayer, updateVerifyDamage, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&GJBaseGameLayer::updateAttemptTime)), Default, GJBaseGameLayer, updateAttemptTime, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<float>::func(&GJBaseGameLayer::updateVisibility)), Default, GJBaseGameLayer, updateVisibility, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<PlayerObject*>::func(&GJBaseGameLayer::playerTookDamage)), Default, GJBaseGameLayer, playerTookDamage, PlayerObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<EffectGameObject*>::func(&GJBaseGameLayer::addToSpeedObjects)), Default, GJBaseGameLayer, addToSpeedObjects, EffectGameObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int, bool, bool>::func(&GJBaseGameLayer::activateEndTrigger)), Default, GJBaseGameLayer, activateEndTrigger, int, bool, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15GJBaseGameLayer28activatePlatformerEndTriggerEP20EndTriggerGameObjectRKSt6vectorIiSaIiEE")), Default, GJBaseGameLayer, activatePlatformerEndTrigger, EndTriggerGameObject*, gd::vector<int> const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(GJBaseGameLayer, toggleGlitter, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<PlayerObject*, GameObject*>::func(&GJBaseGameLayer::destroyPlayer)), Default, GJBaseGameLayer, destroyPlayer, PlayerObject*, GameObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCArray*>::func(&GJBaseGameLayer::updateDisabledObjectsLastPos)), Default, GJBaseGameLayer, updateDisabledObjectsLastPos, cocos2d::CCArray*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJBaseGameLayer::didRotateGameplay)), Default, GJBaseGameLayer, didRotateGameplay, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<GameObject*, float>::func(&GJBaseGameLayer::updateTimeWarp)), Default, GJBaseGameLayer, updateTimeWarp, GameObject*, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&GJBaseGameLayer::playGravityEffect)), Default, GJBaseGameLayer, playGravityEffect, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<GameObject*>::func(&GJBaseGameLayer::manualUpdateObjectColors)), Default, GJBaseGameLayer, manualUpdateObjectColors, GameObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int, int, bool>::func(&GJBaseGameLayer::updateTimeLabel)), Default, GJBaseGameLayer, updateTimeLabel, int, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJBaseGameLayer::checkSnapshot)), Default, GJBaseGameLayer, checkSnapshot, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJBaseGameLayer::toggleProgressbar)), Default, GJBaseGameLayer, toggleProgressbar, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJBaseGameLayer::toggleInfoLabel)), Default, GJBaseGameLayer, toggleInfoLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJBaseGameLayer::removeAllCheckpoints)), Default, GJBaseGameLayer, removeAllCheckpoints, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJBaseGameLayer::toggleMusicInPractice)), Default, GJBaseGameLayer, toggleMusicInPractice, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<GameObject*>::func(&GJBaseGameLayer::addToObjectsToShow)), Default, GJBaseGameLayer, addToObjectsToShow, GameObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJBaseGameLayer::getRecordString)), Default, GJBaseGameLayer, getRecordString, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<GameObject*, float, float>::func(&GJBaseGameLayer::moveAreaObject)), Default, GJBaseGameLayer, moveAreaObject, GameObject*, float, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float>::func(&GJBaseGameLayer::processCommands)), Default, GJBaseGameLayer, processCommands, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&GJBaseGameLayer::processQueuedButtons)), Default, GJBaseGameLayer, processQueuedButtons, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int, bool, bool>::func(&GJBaseGameLayer::queueButton)), Default, GJBaseGameLayer, queueButton, int, bool, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&GJBaseGameLayer::togglePlayerStreakBlend)), Default, GJBaseGameLayer, togglePlayerStreakBlend, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<GameObject*>::func(&GJBaseGameLayer::updateAreaObjectLastValues)), Default, GJBaseGameLayer, updateAreaObjectLastValues, GameObject*)
