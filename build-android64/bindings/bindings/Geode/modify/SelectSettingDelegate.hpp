...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SelectSettingDelegate> : ModifyBase<ModifyDerive<Der, SelectSettingDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<SelectSettingLayer*>::func(&SelectSettingDelegate::selectSettingClosed)), Default, SelectSettingDelegate, selectSettingClosed, SelectSettingLayer*)
		}
	};
}
