...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJDailyLevelDelegate> : ModifyBase<ModifyDerive<Der, GJDailyLevelDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<GJTimedLevelType>::func(&GJDailyLevelDelegate::dailyStatusFinished)), Default, GJDailyLevelDelegate, dailyStatusFinished, GJTimedLevelType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<GJTimedLevelType, GJErrorCode>::func(&GJDailyLevelDelegate::dailyStatusFailed)), Default, GJDailyLevelDelegate, dailyStatusFailed, GJTimedLevelType, GJErrorCode)
		}
	};
}
