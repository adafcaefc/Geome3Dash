...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CommentUploadDelegate> : ModifyBase<ModifyDerive<Der, CommentUploadDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int>::func(&CommentUploadDelegate::commentUploadFinished)), Default, CommentUploadDelegate, commentUploadFinished, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int, CommentError>::func(&CommentUploadDelegate::commentUploadFailed)), Default, CommentUploadDelegate, commentUploadFailed, int, CommentError)
