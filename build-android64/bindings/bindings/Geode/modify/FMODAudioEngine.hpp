...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FMODAudioEngine> : ModifyBase<ModifyDerive<Der, FMODAudioEngine>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngineC2Ev")), Default, FMODAudioEngine, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN15FMODAudioEngine9loadMusicESsfffbii")), Default, FMODAudioEngine, loadMusic, gd::string, float, float, float, bool, int, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<std::unordered_set<int, std::hash<int>, std::equal_to<int>, std::allocator<int> >&>::func(&FMODAudioEngine::stopMusicNotInSet)), Default, FMODAudioEngine, stopMusicNotInSet, std::unordered_set<int, std::hash<int>, std::equal_to<int>, std::allocator<int> >&)
