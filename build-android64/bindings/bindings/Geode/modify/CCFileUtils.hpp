...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCFileUtils> : ModifyBase<ModifyDerive<Der, cocos2d::CCFileUtils>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCFileUtils::getAndroidPath)), Default, cocos2d::CCFileUtils, getAndroidPath, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN7cocos2d11CCFileUtils14setAndroidPathESs")), Default, cocos2d::CCFileUtils, setAndroidPath, gd::string)
