...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJAccountBackupDelegate> : ModifyBase<ModifyDerive<Der, GJAccountBackupDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJAccountBackupDelegate::backupAccountFinished)), Default, GJAccountBackupDelegate, backupAccountFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<BackupAccountError, int>::func(&GJAccountBackupDelegate::backupAccountFailed)), Default, GJAccountBackupDelegate, backupAccountFailed, BackupAccountError, int)
		}
	};
}
