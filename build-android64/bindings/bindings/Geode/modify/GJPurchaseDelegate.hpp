...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJPurchaseDelegate> : ModifyBase<ModifyDerive<Der, GJPurchaseDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<GJStoreItem*>::func(&GJPurchaseDelegate::didPurchaseItem)), Default, GJPurchaseDelegate, didPurchaseItem, GJStoreItem*)
		}
	};
}
