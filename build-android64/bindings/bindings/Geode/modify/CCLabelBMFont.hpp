...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCLabelBMFont> : ModifyBase<ModifyDerive<Der, cocos2d::CCLabelBMFont>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCLabelBMFont::getConfiguration)), Default, cocos2d::CCLabelBMFont, getConfiguration, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCLabelBMFont::getExtraKerning)), Default, cocos2d::CCLabelBMFont, getExtraKerning, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCLabelBMFont::getIsBatched)), Default, cocos2d::CCLabelBMFont, getIsBatched, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCLabelBMFont::getTargetArray)), Default, cocos2d::CCLabelBMFont, getTargetArray, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<int>::func(&cocos2d::CCLabelBMFont::setExtraKerning)), Default, cocos2d::CCLabelBMFont, setExtraKerning, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCLabelBMFont::setIsBatched)), Default, cocos2d::CCLabelBMFont, setIsBatched, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCArray*>::func(&cocos2d::CCLabelBMFont::setTargetArray)), Default, cocos2d::CCLabelBMFont, setTargetArray, cocos2d::CCArray*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccColor3B const&>::func(&cocos2d::CCLabelBMFont::setColor)), Default, cocos2d::CCLabelBMFont, setColor, cocos2d::_ccColor3B const&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccColor3B const&>::func(&cocos2d::CCLabelBMFont::updateDisplayedColor)), Default, cocos2d::CCLabelBMFont, updateDisplayedColor, cocos2d::_ccColor3B const&)
