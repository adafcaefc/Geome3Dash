...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCLayerRGBA> : ModifyBase<ModifyDerive<Der, cocos2d::CCLayerRGBA>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccColor3B const&>::func(&cocos2d::CCLayerRGBA::setColor)), Default, cocos2d::CCLayerRGBA, setColor, cocos2d::_ccColor3B const&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccColor3B const&>::func(&cocos2d::CCLayerRGBA::updateDisplayedColor)), Default, cocos2d::CCLayerRGBA, updateDisplayedColor, cocos2d::_ccColor3B const&)
