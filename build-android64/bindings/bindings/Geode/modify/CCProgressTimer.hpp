...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCProgressTimer> : ModifyBase<ModifyDerive<Der, cocos2d::CCProgressTimer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCProgressTimer::getBarChangeRate)), Default, cocos2d::CCProgressTimer, getBarChangeRate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCProgressTimer::getPercentage)), Default, cocos2d::CCProgressTimer, getPercentage, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCProgressTimer::getType)), Default, cocos2d::CCProgressTimer, getType, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCPoint>::func(&cocos2d::CCProgressTimer::setBarChangeRate)), Default, cocos2d::CCProgressTimer, setBarChangeRate, cocos2d::CCPoint)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<bool>::func(&cocos2d::CCProgressTimer::setReverseDirection)), Default, cocos2d::CCProgressTimer, setReverseDirection, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCProgressTimer::isReverseDirection)), Default, cocos2d::CCProgressTimer, isReverseDirection, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccColor3B const&>::func(&cocos2d::CCProgressTimer::setColor)), Default, cocos2d::CCProgressTimer, setColor, cocos2d::_ccColor3B const&)
