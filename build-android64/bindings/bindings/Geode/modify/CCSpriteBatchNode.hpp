...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCSpriteBatchNode> : ModifyBase<ModifyDerive<Der, cocos2d::CCSpriteBatchNode>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::_ccBlendFunc>::func(&cocos2d::CCSpriteBatchNode::setBlendFunc)), Default, cocos2d::CCSpriteBatchNode, setBlendFunc, cocos2d::_ccBlendFunc)
