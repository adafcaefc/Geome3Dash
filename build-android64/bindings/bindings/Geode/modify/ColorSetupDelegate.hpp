...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ColorSetupDelegate> : ModifyBase<ModifyDerive<Der, ColorSetupDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int>::func(&ColorSetupDelegate::colorSetupClosed)), Default, ColorSetupDelegate, colorSetupClosed, int)
		}
	};
}
