...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ShareCommentDelegate> : ModifyBase<ModifyDerive<Der, ShareCommentDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(reinterpret_cast<uintptr_t>(dlsym(dlopen("libcocos2dcpp.so", RTLD_NOW), "_ZN20ShareCommentDelegate18shareCommentClosedESsP17ShareCommentLayer")), Default, ShareCommentDelegate, shareCommentClosed, gd::string, ShareCommentLayer*)
		}
	};
}
