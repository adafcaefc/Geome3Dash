...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SelectPremadeDelegate> : ModifyBase<ModifyDerive<Der, SelectPremadeDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<SelectPremadeLayer*, int>::func(&SelectPremadeDelegate::selectPremadeClosed)), Default, SelectPremadeDelegate, selectPremadeClosed, SelectPremadeLayer*, int)
		}
	};
}
