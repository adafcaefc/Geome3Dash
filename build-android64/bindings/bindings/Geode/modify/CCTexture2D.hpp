...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTexture2D> : ModifyBase<ModifyDerive<Der, cocos2d::CCTexture2D>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, cocos2d::_ccFontDefinition*>::func(&cocos2d::CCTexture2D::initWithString)), Default, cocos2d::CCTexture2D, initWithString, char const*, cocos2d::_ccFontDefinition*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::_ccTexParams*>::func(&cocos2d::CCTexture2D::setTexParameters)), Default, cocos2d::CCTexture2D, setTexParameters, cocos2d::_ccTexParams*)
