...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UserListDelegate> : ModifyBase<ModifyDerive<Der, UserListDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCArray*, UserListType>::func(&UserListDelegate::getUserListFinished)), Default, UserListDelegate, getUserListFinished, cocos2d::CCArray*, UserListType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<UserListType, GJErrorCode>::func(&UserListDelegate::getUserListFailed)), Default, UserListDelegate, getUserListFailed, UserListType, GJErrorCode)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCArray*, UserListType>::func(&UserListDelegate::userListChanged)), Default, UserListDelegate, userListChanged, cocos2d::CCArray*, UserListType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<UserListType>::func(&UserListDelegate::forceReloadList)), Default, UserListDelegate, forceReloadList, UserListType)
		}
	};
}
