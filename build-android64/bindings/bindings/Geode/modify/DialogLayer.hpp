...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, DialogLayer> : ModifyBase<ModifyDerive<Der, DialogLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::enumKeyCodes>::func(&DialogLayer::keyDown)), Default, DialogLayer, keyDown, cocos2d::enumKeyCodes)
