...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ColorSelectDelegate> : ModifyBase<ModifyDerive<Der, ColorSelectDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCNode*>::func(&ColorSelectDelegate::colorSelectClosed)), Default, ColorSelectDelegate, colorSelectClosed, cocos2d::CCNode*)
		}
	};
}
