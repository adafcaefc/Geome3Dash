...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJRewardDelegate> : ModifyBase<ModifyDerive<Der, GJRewardDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int>::func(&GJRewardDelegate::rewardsStatusFinished)), Default, GJRewardDelegate, rewardsStatusFinished, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&GJRewardDelegate::rewardsStatusFailed)), Default, GJRewardDelegate, rewardsStatusFailed, )
		}
	};
}
