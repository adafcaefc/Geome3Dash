...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, PlayerObject> : ModifyBase<ModifyDerive<Der, PlayerObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x38cac0, Thiscall, PlayerObject, setScaleX, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x38cae0, Thiscall, PlayerObject, setScaleY, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x38cad0, Thiscall, PlayerObject, setScale, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x38c9f0, Thiscall, PlayerObject, setRotation, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x377490, Thiscall, PlayerObject, runBallRotation, float)
