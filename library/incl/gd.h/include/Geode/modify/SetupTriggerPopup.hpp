...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x93d98, Thiscall, SetupTriggerPopup, ccTouchBegan, cocos2d::CCTouch*, cocos2d::CCEvent*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupTriggerPopup, textInputClosed, , CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x45d4e0, Thiscall, SetupTriggerPopup, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupTriggerPopup, textInputShouldOffset, , CCTextInputNode*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupTriggerPopup, textInputReturn, , CCTextInputNode*)
