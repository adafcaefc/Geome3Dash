...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupOpacityPopup> : ModifyBase<ModifyDerive<Der, SetupOpacityPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupOpacityPopup, create, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupOpacityPopup, determineStartValues, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupOpacityPopup, updateDurLabel, , bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupOpacityPopup, updateOpacity, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupOpacityPopup, updateOpacityLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupOpacityPopup, updateTargetID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupOpacityPopup, updateTextInputLabel, )
		}
	};
}
