...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJRequestCell> : ModifyBase<ModifyDerive<Der, GJRequestCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRequestCell, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRequestCell, draw, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRequestCell, onClosePopup, , UploadActionPopup*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xbb640, Thiscall, GJRequestCell, loadFromScore, GJUserScore*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRequestCell, markAsRead, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRequestCell, onDeleteRequest, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRequestCell, onToggle, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRequestCell, onViewFriendRequest, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRequestCell, onViewProfile, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRequestCell, updateBGColor, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRequestCell, updateToggle, )
		}
	};
}
