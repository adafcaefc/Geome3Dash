...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FMODAudioEngine> : ModifyBase<ModifyDerive<Der, FMODAudioEngine>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(FMODAudioEngine, fadeMusic, , float, int, float, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(FMODAudioEngine, isAnyPersistentPlaying, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(FMODAudioEngine, isPersistentMatchPlaying, , gd::string, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5a280, Thiscall, FMODAudioEngine, loadMusic, gd::string, float, float, float, bool, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(FMODAudioEngine, loadMusic, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(FMODAudioEngine, loadMusic, , gd::string, float, float, float, bool, int, int, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(FMODAudioEngine, startMusic, , int, int, int, int, bool, int, bool, bool)
