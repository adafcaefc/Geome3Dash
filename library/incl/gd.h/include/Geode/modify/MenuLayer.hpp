...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MenuLayer> : ModifyBase<ModifyDerive<Der, MenuLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MenuLayer, onDiscord, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(MenuLayer, onEveryplay, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MenuLayer, onFacebook, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MenuLayer, onFreeLevels, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MenuLayer, onFullVersion, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MenuLayer, onGameCenter, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x320f00, Thiscall, MenuLayer, onGarage, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MenuLayer, onGooglePlayGames, , cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MenuLayer, onNewgrounds, , cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MenuLayer, onTwitch, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MenuLayer, onTwitter, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MenuLayer, onYouTube, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x320bd0, Thiscall, MenuLayer, openOptions, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MenuLayer, showGCQuestion, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MenuLayer, syncPlatformAchievements, , float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MenuLayer, tryShowAd, , float)
