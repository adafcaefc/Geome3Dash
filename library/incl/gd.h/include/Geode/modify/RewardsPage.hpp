...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, RewardsPage> : ModifyBase<ModifyDerive<Der, RewardsPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(RewardsPage, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(RewardsPage, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(RewardsPage, show, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(RewardsPage, onClose, , cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(RewardsPage, tryGetRewards, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(RewardsPage, unlockLayerClosed, RewardUnlockLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(RewardsPage, updateTimers, , float)
		}
	};
}
