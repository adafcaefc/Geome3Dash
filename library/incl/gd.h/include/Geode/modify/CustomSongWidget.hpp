...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CustomSongWidget> : ModifyBase<ModifyDerive<Der, CustomSongWidget>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CustomSongWidget, addExtraVisuals, , bool, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CustomSongWidget, downloadFailed, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CustomSongWidget, onCancelDownload, , cocos2d::CCObject*)
