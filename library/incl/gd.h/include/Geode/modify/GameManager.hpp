...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GameManager> : ModifyBase<ModifyDerive<Der, GameManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(base::get() + 0x177af0, Thiscall, GameManager)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameManager, reloadAllStep3, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameManager, reloadAllStep4, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameManager, resumeAudio, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameManager, resumeAudioDelayed, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameManager, switchScreenMode, , bool, bool, bool, bool)
